m=20;%TIEMPO DE SIMULACIÓN EN SIMULINK
...
D=[];
% CANTIDAD DE BITS DE TAMAÑO 100
lb=floor(length(imp)/100)-1;
% CICLO DE RECONSTRUCCIÓN DE LA TRAMA
for n=0:lb
    D=[D;par(n*100+1:100*(n+1));imp(n*100+1:100*(n+1))];
end
% TIEMPO DE RECONSTRUCCIÓN DE LA TRAMA PARA AJUSTARLO AL ANCHO DE BIR
% ORIGINAL
tiempo=(1:1/180:50)';
subplot(3,1,3)
